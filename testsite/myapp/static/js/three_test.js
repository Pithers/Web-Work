...
//https://blog.mozvr.com/procedural-geometry-low-poly-c90louds/
...
//Canvas overflows by a small amount. This is used to adjust that
width_adjust = 17
...
var outscene = new THREE.Scene(); //For outlining
...
//Mesh Types
var material_basic = new THREE.MeshBasicMaterial({color: 0xffffff});
var material_standard = new THREE.MeshStandardMaterial({roughness: 0});
...
function addWindStream() {
  ...
  //create two times as many vertices as points; push them in opposing directions to create a ribbon
...
THREE.DefaultLoadingManager.onLoad = function() {
  ...
  //text2.material.color.set(color_text);
...
var fixed_frame_rate = 90; //Stats.js claims this is equivalent to 60fps, might be due to ~60fps cap by code
